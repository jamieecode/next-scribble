...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "productIndex" ON "reviews" USING btree ("productID");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "userIndex" ON "reviews" USING btree ("userID");